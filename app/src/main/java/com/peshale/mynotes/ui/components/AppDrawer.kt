package com.peshale.mynotes.ui.components
...
import com.peshale.mynotes.routing.NotesRouter
import com.peshale.mynotes.routing.Screen
import com.peshale.mynotes.theme.NotesTheme
import com.peshale.mynotes.theme.NotesThemeSettings
...
//Switcher for light and dark theme
@Composable
fun ThemeSwitcher() {
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        AppDrawerHeader()
        Divider(color = MaterialTheme.colors.onSurface.copy(alpha = .2f), thickness = 1.dp)
        ScreenNavigationButton(
            icon = Icons.Filled.Home,
            label = "Notes",
